      ...
      <form id="search-form" class="form-inline my-2 my-lg-0" action='./search.php' method='get'>
        <div class="input-group">
          <div class="input-group-prepend">
            <select id="search-dropdown" name="scope" form="" onchange="changeSearchAction();">
        ...
        <button id="search-button" class="btn btn-outline-success my-2 my-sm-0 search" type="submit" onclick="saveSearchState();">Search</button>
      </form>
    </div>
